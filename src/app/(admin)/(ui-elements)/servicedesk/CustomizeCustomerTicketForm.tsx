...
const CustomizeCustomerTicketForm = () => {
    ...
    const loadCustomerTicketFormConfig = async () => {
        try {
            const response = await fetch(`${process.env['NEXT_PUBLIC_API_URL'] || "https://py-mobiloitte.converiqo.ai"}/customize/admin/customize-customer-ticket-form?widget_id=Model`, {
                method: 'GET',
                headers: {
